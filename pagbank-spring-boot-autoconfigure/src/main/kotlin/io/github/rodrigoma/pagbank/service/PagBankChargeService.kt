...
import io.github.rodrigoma.pagbank.model.charge.ChargeListResponse
import io.github.rodrigoma.pagbank.model.charge.ChargeResponse
...
class PagBankChargeService(
    ...
    fun retry(
        id: String,
        request: RetryChargeRequest = RetryChargeRequest(),
    ) {
        restClient
            .post()
