...
import com.example.pagbank.autoconfigure.PagBankProperties
import com.example.pagbank.model.webhook.WebhookPayload
...
class PagBankWebhookParser(private val properties: PagBankProperties) {
