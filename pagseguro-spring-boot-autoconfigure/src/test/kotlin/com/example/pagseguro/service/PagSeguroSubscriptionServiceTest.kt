...
import com.example.pagseguro.model.subscription.*
...
class PagSeguroSubscriptionServiceTest {

    private lateinit var service: PagSeguroSubscriptionService
    ...
    fun setUp() {
        val restClient = RestClient.builder()
            ...
            .build()
        service = PagSeguroSubscriptionService(restClient)
    }
